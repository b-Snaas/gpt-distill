    ...
    for step in range(num_iterations + 1):
        ...
        if step % 100 == 0:
            try:
                ...
                with open("/home/bsnaas/git/gpt-distill/logs/distill_cuda_time.txt", "a") as cuda_log_file:
                    cuda_log_file.write(prof.key_averages().table(sort_by="cuda_time_total"))
                    cuda_log_file.write("\n\n")

                with open("/home/bsnaas/git/gpt-distill/logs/distill_memory_usage.txt", "a") as cpu_mem_log_file:
